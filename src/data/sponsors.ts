  ...
  Gold: [
    {
      ...
      name: "Mapletree",
      description:
        "Global real estate development, investment, capital and property management company committed to sustainability",
      tier: "Gold",
      ...
      links: [
        {
          href: "https://www.studentcastle.co.uk/locations/cambridge-student-accommodation",
          title: "Student Castle Accommodation",
        },
      ],
    },
    {
      ...
      description:
        "Learn how we as the Infocomm Media Development Authority (IMDA) drive Singapore's digital transformation by building a vibrant digital economy and an inclusive digital society.",
      tier: "Gold",
      ...
      headquarters: "Singapore",
      links: [
        { href: "https://go.gov.sg/SGDScholarships", title: "Scholarships" },
      ],
    },
    {
      id: "setia",
    ...
    },
    {
      ...
      name: "Nomura",
      description:
        "Nomura is a financial services group with an integrated global network.",
      tier: "Gold",
  ...
  Silver: [
    {
      ...
      headquarters: "Singapore",
      links: [
        { href: "http://www.go.gov.sg/mhascholarships", title: "Scholarships" },
        { href: "http://www.mha.gov.sg/careers", title: "Careers" },
        {
          href: "https://www.mha.gov.sg/careers/internships",
          title: "Internships",
        },
        {
          href: "http://www.linkedin.com/company/mhasingapore",
          title: "LinkedIn",
        },
      ],
    },
...
export const sponsorsList = Object.values(sponsors).flat();

// Helper function to find sponsor by slug
export const slugMap: Record<string, Sponsor> = Object.fromEntries(
  sponsorsList.map((sponsor): [string, Sponsor] => [sponsor.slug, sponsor]),
);
