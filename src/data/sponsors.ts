...
export const sponsorsData: Sponsor[] = [
    ...
    footerLinks: [
      {
        ...
        url: "https://www.studentcastle.co.uk/locations/cambridge-student-accommodation",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    footerLinks: [
      ...
      {
        title: "Internships",
        url: "https://www.mha.gov.sg/careers/internships",
      },
      {
        title: "LinkedIn",
        url: "http://www.linkedin.com/company/mhasingapore",
      },
    ],
  },
  {
...
export const getPlatinumSponsors = () =>
  sponsorsData.filter((sponsor) => sponsor.tier === "platinum");
export const getGoldSponsors = () =>
  sponsorsData.filter((sponsor) => sponsor.tier === "gold");
export const getSilverSponsors = () =>
  sponsorsData.filter((sponsor) => sponsor.tier === "silver");

// Helper function to find sponsor by slug
export const getSponsorBySlug = (slug: string) =>
  sponsorsData.find((sponsor) => sponsor.slug === slug);
